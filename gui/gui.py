...
def start_page():
    ...
    title_frame.pack(pady=10, padx=10, fill="x", expand=True)
...
def patient_page(): 
    ...
    login_button.grid(row=3, column=0, pady=50, padx=10, sticky="ne")
    ...
    next_patient_button.grid(row=3, column=1, pady=50, padx=10, sticky="nw")
