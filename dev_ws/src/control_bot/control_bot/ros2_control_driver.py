...
class TwistToPWMMode(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(String, 'test_topic', self.cmd_vel_callback, 10)
    ...
    def cmd_vel_callback(self, msg):
        MotorPWM = msg.data.split(" ")
        self.get_logger().info("First PWM: {0}, Second PWM: {1}".format(MotorPWM[0], MotorPWM[1]))
